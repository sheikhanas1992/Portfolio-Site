...
import { a as MetricStrip, c as clientLabel, i as CasePage, n as CaseFooter, o as Screenshot, r as CaseHeader, s as Section, t as Bar } from "./CaseBits-D9c7eLnF.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/work.scale-and-concentration-BUKX802a.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CasePage, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 max-w-[70ch] text-[0.9rem] italic leading-relaxed text-[#9a9a9e]",
					children: "Seller Central's own daily trend chart, unedited."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
			title: "The products carrying the brand",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-[20px] border border-white/[0.08] bg-[#151517] px-7 py-4",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, {

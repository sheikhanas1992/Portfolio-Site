...
function SiteFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
		className: "mx-auto mt-24 flex max-w-[1100px] flex-col items-center gap-4 border-t border-white/[0.1] px-6 py-10 text-[0.8rem] font-semibold text-[#c7c7cc] md:flex-row md:justify-between md:px-10",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			...
			className: "flex gap-6 font-mono uppercase tracking-[0.12em]",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
					href: CONTACT.linkedin,
					...ext,

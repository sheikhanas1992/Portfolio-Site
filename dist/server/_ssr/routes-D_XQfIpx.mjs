...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-D_XQfIpx.js
					...
					children: CARDS.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "text-[clamp(1.1rem,4.2vw,1.35rem)] font-bold normal-case leading-[1.35] text-[#EDE8E0]",
